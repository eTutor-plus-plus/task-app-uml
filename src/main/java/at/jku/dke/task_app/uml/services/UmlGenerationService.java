        ...
        for (String combination : allCombinations) {
            ...
            for (UMLClass umlClass : result.getUmlClasses()) {
                ...
                for (UMLAttribute attribute : umlClass.getAttributes()) {
                    if (!attribute.getType().equals("special")) {
                    ...
                    if (!attribute.getType().equals("normal") && !attribute.getType().equals("special")) {
                        {
                            currentPoints += umlTask.getConstraintPoints().doubleValue();
                        }
                    }
            ...
            for (UMLMultiRelationship multiRelationship : result.getMultiRelationships()) {
