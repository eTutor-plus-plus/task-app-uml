...
public class PlantUML_ATGLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "RELATION_TYPE", "StringLiteral", "COLON", "SEMICOLON",
			"COMMA", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "LT", "GT", "STAR",
			"PLUS", "QUESTION", "DIAMOND", "SKINPARAM_LINE", "WS", "Identifier",
			"Integer"
		};
	}
	...
	public PlantUML_ATGLexer(CharStream input) {
		super(input);
