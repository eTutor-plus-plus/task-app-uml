...
public class PlantUML_ATGParser extends Parser {
	...
	public static final int
		...
		T__17=18, T__18=19, RELATION_TYPE=20, StringLiteral=21, COLON=22, SEMICOLON=23,
		COMMA=24, LPAREN=25, RPAREN=26, LBRACE=27, RBRACE=28, LT=29, GT=30, STAR=31,
		PLUS=32, QUESTION=33, DIAMOND=34, SKINPARAM_LINE=35, WS=36, Identifier=37,
		Integer=38;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, "RELATION_TYPE", "StringLiteral",
	...
	public final ClassDiagramContext classDiagram() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 158950425856L) != 0)) {
				{
				setState(70);
				_errHandler.sync(this);
	...
	public static class ConstraintsContext extends ParserRuleContext {
		public ConstraintmemberContext constraintmember1;
		public ConstraintmemberContext constraintmember2;
	...
	public final ConstraintsContext constraints() throws RecognitionException {
		...
		try {
			...
			{
			setState(94);
			((ConstraintsContext)_localctx).constraintmember1 = constraintmember();
			setState(95);
			match(T__2);
			setState(96);
			((ConstraintsContext)_localctx).constraintmember2 = constraintmember();
			setState(97);
			match(COLON);
			setState(98);
			match(LBRACE);
	...
	public final ClassDefinitionContext classDefinition() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4295426048L) != 0)) {
				{
				setState(133);
				visibility();
				}
	...
	public final SpeciallabelContext speciallabel() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 429077299200L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
